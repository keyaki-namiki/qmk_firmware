 ...
 */
	...
	#define LAYOUT_minev3(\
		...
		{ L40, L41, L42, L43, L44, L45, L46 }, \
		{ L50, L51, L52, L53, L54, L55, L56 }, \
		{ KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, L03, L04 }, \
		...
		{ R30, R31, R32, R33, R34, R35, R2B, R1B, R0C, R0B, KC_NO },\
		}
		...
		#define LAYOUT(\
			...
			{ KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, R03, R04 }, \
			}
	#else
		#define LAYOUT(\
			k00, k01, k02,      k03,      k04, \
			...
			{ k40, k41, k42, k43, k44, k45, k46 }, \
			{ k50, k51, k52, k53, k54, k55, k56 }, \
			{ KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, k03, k04 }, \
			}
	#endif
#endif