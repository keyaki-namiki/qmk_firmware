...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_LOWER] = LAYOUT( \
      EEP_RST, RGB_HUI, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
      KC_TILD, RGB_HUD, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
